"""
author： mask
filename: test_lock_user.py
datetime： 2021/4/6 14:16 
ide： PyCharm
"""
import unittest
...
from interfaces.lock_user import lockUser
from common.get_expect_data import get_expect


@ddt
class testLockUser(unittest.TestCase, lockUser):
    ...
    @data(*(get_expect('bms_test_data.xlsx', 'memberCentre', 9)))
    def test_lock_user(self, test_data):
        """
        测试锁定会员账号接口
        :param test_data:
        :return:
        """
        res = lockUser().lock_user()
        ...
        self.log.info('请求接口:{}'.format(lockUser().url))
