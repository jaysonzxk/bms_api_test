"""
author： mask
filename: test_login_log.py
datetime： 2021/4/6 16:25 
ide： PyCharm
"""
import unittest
from ddt import data, ddt
from common.logger import Log
from interfaces.login_log import userLoginLog
from common.get_expect_data import get_expect


@ddt
class testLoginLog(unittest.TestCase, userLoginLog):

    @classmethod
    def setUpClass(cls) -> None:
        cls.log = Log()
        cls.data = userLoginLog().test_data

    @data(*(get_expect('bms_test_data.xlsx', 'memberCentre', 20)))
    def test_login_log(self, test_data):
        """
        测试会员登录日志接口
        :param test_data:
        :return:
        """
        res = userLoginLog().login_log()
        ...
        self.log.info('请求接口:{}'.format(userLoginLog().url))
