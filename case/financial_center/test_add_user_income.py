"""
author： mask
filename: test_add_user_income.py
datetime： 2021/4/10 13:50 
ide： PyCharm
"""
import unittest
from ddt import data, ddt
from common.logger import Log
from interfaces.add_user_income import addUserIncome
from common.get_expect_data import get_expect


@ddt
class testAddUserIncome(unittest.TestCase, addUserIncome):

    @classmethod
    def setUpClass(cls) -> None:
        cls.log = Log()
        cls.data = addUserIncome().test_data

    @data(*(get_expect('bms_test_data.xlsx', 'financialCenter', 1)))
    def test_add_user_income(self, test_data):
        """
        测试会员入款列表
        :param test_data:
        :return:
        ...
        self.log.info('请求接口:{}'.format(addUserIncome().url))
