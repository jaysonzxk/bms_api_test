...
class disableReturnPoint:
    ...
    def __init__(self):
        self.log = Log()
        self.test_data = get_test_data('bms_test_data.xlsx', 'memberCentre', 14)
    ...
    def disable_return_point(self):
        ...
        try:
            ...
            self.log.error('bms后台禁止会员返点接口异常:{}，请检查'.format(str(e)))