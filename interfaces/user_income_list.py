"""
author： mask
filename: user_income_list.py
datetime： 2021/4/10 13:36 
ide： PyCharm
"""
...
class memberIncomeList:
    ...
    def __init__(self):
        self.log = Log()
        self.test_data = get_test_data('bms_test_data.xlsx', 'financialCenter', 0)
    ...
    def get_member_income_list(self):
        """
        bms-获取会员入款列表
        :return:
        """
        try:
            ...
            self.log.error('bms后台获取会员入款列表接口异常:{}，请检查'.format(str(e)))
