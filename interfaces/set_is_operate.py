"""
author： mask
filename: set_is_operate.py
datetime： 2021/4/6 15:52 
ide： PyCharm
"""
...
class setIsOperate:
    ...
    def __init__(self):
        self.log = Log()
        self.test_data = get_test_data('bms_test_data.xlsx', 'memberCentre', 16)
    ...
    def set_is_operate(self):
        ...
        try:
            ...
            self.log.error('bms后台设置运营账号接口异常:{}，请检查'.format(str(e)))