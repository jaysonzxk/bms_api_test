"""
author： mask
filename: cancel_is_operate.py
datetime： 2021/4/6 15:56 
ide： PyCharm
"""
...
class cancelIsOperate:
    ...
    def __init__(self):
        self.log = Log()
        self.test_data = get_test_data('bms_test_data.xlsx', 'memberCentre', 17)
    ...
    def cancel_is_operate(self):
        ...
        try:
            ...
            self.log.error('bms后台设置正式账号接口异常:{}，请检查'.format(str(e)))